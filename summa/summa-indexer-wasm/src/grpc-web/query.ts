...
class QueryParserConfig$Type extends MessageType<QueryParserConfig> {
    ...
    create(value?: PartialMessage<QueryParserConfig>): QueryParserConfig {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.field_aliases = {};
        message.field_boosts = {};
        message.term_field_mapper_configs = {};
        message.term_limit = 0;
        message.default_fields = [];
        message.default_mode = { oneofKind: undefined };
        message.excluded_fields = [];
        message.morphology_configs = {};
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for summa.proto.QueryParserConfig.field_aliases");
            }
        }
        map[key ?? ""] = val ?? "";
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.float();
                    break;
                default: throw new globalThis.Error("unknown map entry field for summa.proto.QueryParserConfig.field_boosts");
            }
        }
        map[key ?? ""] = val ?? 0;
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    ...
                    break;
                default: throw new globalThis.Error("unknown map entry field for summa.proto.QueryParserConfig.term_field_mapper_configs");
            }
        }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    ...
                    break;
                default: throw new globalThis.Error("unknown map entry field for summa.proto.QueryParserConfig.morphology_configs");
            }
        }
    ...
    internalBinaryWrite(message: QueryParserConfig, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let k of globalThis.Object.keys(message.field_aliases))
        ...
        for (let k of globalThis.Object.keys(message.field_boosts))
        ...
        for (let k of globalThis.Object.keys(message.term_field_mapper_configs)) {
        ...
        for (let k of globalThis.Object.keys(message.morphology_configs)) {
...
class SearchRequest$Type extends MessageType<SearchRequest> {
    constructor() {
        super("summa.proto.SearchRequest", [
            ...
            { no: 3, name: "collectors", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Collector },
...
class SearchResponse$Type extends MessageType<SearchResponse> {
    constructor() {
        super("summa.proto.SearchResponse", [
            ...
            { no: 2, name: "collector_outputs", kind: "message", localName: "collector_outputs", repeat: 2 /*RepeatType.UNPACKED*/, T: () => CollectorOutput }
        ]);
    }
    create(value?: PartialMessage<SearchResponse>): SearchResponse {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.elapsed_secs = 0;
        message.collector_outputs = [];
        if (value !== undefined)
...
class DisjunctionMaxQuery$Type extends MessageType<DisjunctionMaxQuery> {
    constructor() {
        super("summa.proto.DisjunctionMaxQuery", [
            { no: 1, name: "disjuncts", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Query },
...
class BooleanQuery$Type extends MessageType<BooleanQuery> {
    constructor() {
        super("summa.proto.BooleanQuery", [
            { no: 1, name: "subqueries", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => BooleanSubquery }
        ]);
    }
...
class Range$Type extends MessageType<Range> {
    ...
    create(value?: PartialMessage<Range>): Range {
        ...
        message.left = "";
        message.right = "";
        message.including_left = false;
        message.including_right = false;
        if (value !== undefined)
...
class Score$Type extends MessageType<Score> {
    ...
    create(value?: PartialMessage<Score>): Score {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.score = { oneofKind: undefined };
        if (value !== undefined)
...
class Snippet$Type extends MessageType<Snippet> {
    constructor() {
        super("summa.proto.Snippet", [
            ...
            { no: 2, name: "highlights", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Highlight },
            { no: 3, name: "html", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value?: PartialMessage<Snippet>): Snippet {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.fragment = new Uint8Array(0);
        message.highlights = [];
        message.html = "";
        if (value !== undefined)
...
class ScoredDocument$Type extends MessageType<ScoredDocument> {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    ...
                    break;
                default: throw new globalThis.Error("unknown map entry field for summa.proto.ScoredDocument.snippets");
            }
        }
    ...
    internalBinaryWrite(message: ScoredDocument, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let k of globalThis.Object.keys(message.snippets)) {
...
class Scorer$Type extends MessageType<Scorer> {
    ...
    create(value?: PartialMessage<Scorer>): Scorer {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.scorer = { oneofKind: undefined };
        if (value !== undefined)
...
class Collector$Type extends MessageType<Collector> {
    ...
    create(value?: PartialMessage<Collector>): Collector {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.collector = { oneofKind: undefined };
        if (value !== undefined)
...
class CollectorOutput$Type extends MessageType<CollectorOutput> {
    ...
    create(value?: PartialMessage<CollectorOutput>): CollectorOutput {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.collector_output = { oneofKind: undefined };
        if (value !== undefined)
...
class FacetCollectorOutput$Type extends MessageType<FacetCollectorOutput> {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    ...
                    break;
                default: throw new globalThis.Error("unknown map entry field for summa.proto.FacetCollectorOutput.facet_counts");
            }
        }
        map[key ?? ""] = val ?? 0n;
    }
    internalBinaryWrite(message: FacetCollectorOutput, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let k of globalThis.Object.keys(message.facet_counts))
...
class ReservoirSamplingCollectorOutput$Type extends MessageType<ReservoirSamplingCollectorOutput> {
    constructor() {
        super("summa.proto.ReservoirSamplingCollectorOutput", [
            { no: 1, name: "documents", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => RandomDocument }
        ]);
    }
...
class TopDocsCollector$Type extends MessageType<TopDocsCollector> {
    ...
    create(value?: PartialMessage<TopDocsCollector>): TopDocsCollector {
        ...
        message.limit = 0;
        message.offset = 0;
        message.snippet_configs = {};
        message.explain = false;
        message.fields = [];
        message.excluded_fields = [];
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.uint32();
                    break;
                default: throw new globalThis.Error("unknown map entry field for summa.proto.TopDocsCollector.snippet_configs");
            }
        }
        map[key ?? ""] = val ?? 0;
    }
    internalBinaryWrite(message: TopDocsCollector, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let k of globalThis.Object.keys(message.snippet_configs))
...
class DocumentsCollectorOutput$Type extends MessageType<DocumentsCollectorOutput> {
    constructor() {
        super("summa.proto.DocumentsCollectorOutput", [
            { no: 1, name: "scored_documents", kind: "message", localName: "scored_documents", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ScoredDocument },
