...
class GetTopTermsResponse$Type extends MessageType<GetTopTermsResponse> {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    ...
                    break;
                default: throw new globalThis.Error("unknown map entry field for summa.proto.GetTopTermsResponse.per_segment");
            }
        }
    ...
    internalBinaryWrite(message: GetTopTermsResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let k of globalThis.Object.keys(message.per_segment)) {
...
class SegmentTerms$Type extends MessageType<SegmentTerms> {
    constructor() {
        super("summa.proto.SegmentTerms", [
            { no: 1, name: "term_infos", kind: "message", localName: "term_infos", repeat: 2 /*RepeatType.UNPACKED*/, T: () => TermInfo }
        ]);
    }
