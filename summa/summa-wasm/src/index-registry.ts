import init, { setup_logging, WrappedIndexRegistry } from "../pkg/summa_wasm";
import { IndexAttributes, IndexEngineConfig } from "./grpc-web/index_service";
export type { IndexAttributes, IndexEngineConfig }
...
export class IndexRegistry implements IIndexRegistry {
  ...
  async setup(
    ...
    try {
      ...
      await init({ module_or_path: init_url + "?force" });
    }
